export const zh = {
  ...
  updates: {
    ...
    items: [
      ...
      {
        date: '2026年5月 — 8月',
        text: '2026 Summer 在 **Apple** 担任软件工程实习生（2026.05.11 — 2026.08.21），构建 cellular ML 模型的 agentic end-to-end training workflow，并围绕 **WWDC26 Call Context** 做 **next-stage extension development**，使用端侧 **LLM** 开发新的 iOS feature。',
        tag: '工作',
    ...
    items: [
      {
        ...
        description: '构建 cellular ML 模型训练、评估、Core ML 打包与 iPhone 性能验证的 agentic developer workflow；围绕 WWDC26 Call Context 做 next-stage extension development，使用端侧 LLM 开发新的 iOS feature，集成跨职能内部设施，并负责 session/prewarm 管理、runtime invocation 与 iPhone 侧验证/性能。',
        current: true,
      },
      {
        role: '研究工程师（AI Agent）',
